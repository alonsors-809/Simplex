...
void Latex_PrintCellsTable_Cell(int i, int j, bool es_primera, int i_pivote, int columna_escogida, bool intermedia){
    if (es_primera){
        if (j == columna_escogida){
            ...
            if ((j>=getColumnasMatriz()-getCantidadArtificiales()-1) && (j<getColumnasMatriz()-1) && intermedia == true )  {
                //Latex_Write(" & a");
            }else{
...
void Latex_PrintCellsTable_FirstRow(int columna_escogida, bool intermedia){
    int columna_actual;
    Latex_Write("\\hline \n");
    Latex_Write("\\textbf{Z} ");
...
void Latex_PrintCellsTable_SecondRow(int i_pivote, int columna_escogida, bool intermedia){
    for (int j = 0 ; j < ColumnasMatriz ; j++){
        if (j == 0){
            ...
            }else{if ((j>=getColumnasMatriz()-getCantidadArtificiales()-1) && (j<getColumnasMatriz()-1) && intermedia == true)  {
                //Latex_Write(" & a");
                }else{
...
void Latex_PrintCellsTable(int i_pivote, int columna_escogida, bool intermedia){
    if (intermedia == true)printf("\nintermedia\n");
    int ColumnasMatriz = getColumnasMatriz();
    int FilasMatriz = getFilasMatriz();
    Latex_PrintCellsTable_FirstRow(columna_escogida, intermedia);
    Latex_PrintCellsTable_SecondRow(i_pivote,columna_escogida, intermedia);
    for (int i = 2 ; i < FilasMatriz ; i++ ){
        Latex_PrintCellsTable_Cell(i,0,true,i_pivote,columna_escogida, intermedia); // Para no imprimir el "&"
        for (int j = 1 ; j < ColumnasMatriz ; j++){
            Latex_PrintCellsTable_Cell(i,j,false,i_pivote,columna_escogida, intermedia);
        }
        Latex_Write("\\\\ \n");
        Latex_Write("\\hline \n");
    }
 ...
 */
void Latex_PrintTable(int numero_tabla, int i_pivote, int columna_escogida, bool canonizada, bool intermedia){
    Latex_PrintStartTable(numero_tabla);
    Latex_PrintCellsTable(i_pivote,columna_escogida, intermedia);
